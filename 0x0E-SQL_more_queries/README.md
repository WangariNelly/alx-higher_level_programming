...
- The length of your file will be tested using `wc`
...
~~~
$sudo mysql
Welcome to your MySQL monitor. Commands end with ; or \g.
Your MySQL connection id is 11
Server version: 8.0.25-0ubuntu.0.20.04.1 (Ubuntu)

Copyright (c) 200, 2021, Oracle and/or its affiliates.
...
$
~~~
<img src='./assets/SQL.png' alt="SQL.png">
